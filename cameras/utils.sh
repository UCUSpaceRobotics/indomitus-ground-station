# ===========================================================================
# Shared shell helpers for scripts that reach the rover's Jetson over SSH
# (cameras/start-cameras.sh and friends). Source this, don't run it:
#   source "$REPO/utils.sh"
# ===========================================================================
...
# USAGE:    wait_for_ssh "user@ip" [max_retries] [use_eth (true/false)]
# ===========================================================================
wait_for_ssh() {
  local target="$1"
